...
func NewImageProcessor(client httpclient.HttpClient) *ImageProcessor {
	return &ImageProcessor{
		client: client,
	}
}

func (i *ImageProcessor) Process(url, text string, fontSize int) ([]byte, error) {
...
func (i *ImageProcessor) getImage(url string) (image.Image, error) {
